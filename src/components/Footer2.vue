    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        ...
        <div class="flex justify-center sm:justify-start">
            <img src="/images/logoH.png" alt="InfyCredit Logo" class="h-12">
        </div>

        <p
          class="mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left dark:text-gray-400"
        >
          lnfyCredit es una solución tecnológica diseñada para facilitar los procesos de colocación y vinculación de las entidades del sector solidario,
microfinanciero y comercio.
        </p>

        <ul class="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8 invisible">
          <li>
            <a
              href="#"
              rel="noreferrer"
      ...
      <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
        <div class="text-center sm:text-left invisible">
        ...
        <div class="text-center sm:text-left invisible">
          <p class="text-lg font-medium text-gray-900 dark:text-white">Nuestros servicios</p>
        ...
        <div class="text-center sm:text-left">
          <p class="text-lg font-medium text-gray-900 dark:text-white">Ayudas</p>
        ...
        <div class="text-center sm:text-left">
          <p class="text-lg font-medium text-gray-900 dark:text-white">Contactenos</p>
          ...
          <ul class="mt-8 space-y-4 text-sm">
            <li>
              ...
              >
                ...
                <span class="flex-1 text-gray-700 dark:text-gray-300"> comercial@infycredit.com </span>
              </a>
            </li>
            ...
            <li>
              ...
              >
                ...
                <span class="flex-1 text-gray-700 dark:text-gray-300">57+ 3158119782</span>
              </a>
            </li>

            <li
              class="flex items-start justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end invisible"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="size-5 shrink-0 text-gray-900 shadow-sm dark:text-white"
    ...
    <div class="mt-12 border-t border-gray-100 pt-6 dark:border-gray-800">
      <div class="text-center sm:flex sm:justify-between sm:text-left">
        <p class="text-sm text-gray-500 dark:text-gray-400 invisible">
